...
async def _send_excel_to_client_with_init_multiple(excel_files: list, parsed_date: date) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        try:
            ...
            result = await _send_multiple_excel_to_client(excel_files, parsed_date)
            return result
...
async def _send_multiple_excel_to_client(excel_files: list, parsed_date: date) -> Dict[str, Any]:
    """
