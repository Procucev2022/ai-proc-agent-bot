        ...
        try:
            ...
            if result:
                ...
                return {
                    ...
                    'rfqs_with_response': int(metrics_dict.get('RFQs with At Least One Response', 0)),
                    'total_rfq_responses': int(metrics_dict.get('Total RFQ Responses', 0)),
                    ...
                    'unregistered_abandoned': int(metrics_dict.get('Unregistered Buyers Initiated Chat But Not Continued', 0)),
                    'user_not_identified': int(metrics_dict.get('Unknown User Sessions', 0)),
