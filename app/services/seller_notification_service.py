...
def _setup_notification_logger() -> logging.Logger:
    ...
    Writes to logs/notifications/notifications_YYYY-MM-DD.log with rotation.
    """
    ...
    # Create logs/notifications directory if it doesn't exist
    log_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "logs", "notifications")
