...
class Settings:
    ...
    def __init__(self):
        ...
        # Multi-pool worker configuration (optional - defaults used if not set)
        self.critical_pool_workers = int(os.getenv("CRITICAL_POOL_WORKERS", "2"))
        ...
        self.license_enabled = os.getenv("LICENSE_ENABLED", "false").lower() == "true"
        
        # Complex encryption key - DO NOT SHARE
        self.license_secret_key = "PrOcUcEv@2025#AI$AgEnT!SecUrE*LiCeNsE&Key^9876"
