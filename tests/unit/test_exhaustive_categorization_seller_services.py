...
Every external boundary in this module is an in-memory double: SQLAlchemy,
...
@pytest.mark.asyncio
async def test_learning_service_covers_entries_and_failures(monkeypatch):
...
@pytest.mark.asyncio
async def test_seller_notifications(monkeypatch):
    wa = MagicMock()
